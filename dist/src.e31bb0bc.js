...
var Artist = function Artist(_ref) {
  ...
  //artist is props returned from App.js
  if (!artist) return null;
  var images = artist.images,
      name = artist.name,
      followers = artist.followers,
      genres = artist.genres; //object destructured, the props from App.js
...
function (_Component) {
  ...
  function Tracks() {
    ...
    _defineProperty(_assertThisInitialized(_this), "trackIcon", function (track) {
      ...
      return _react.default.createElement("span", null, "\u25B6"); //play button
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function () {
      fetch("".concat(API_ADDRESS, "/artist/").concat(_this.state.artistQuery)).then(function (response) {
        ...
        if (json.artists.total > 0) {
          ...
          _this.setState({
            artist: artist
          }); //could be written as-this.setState({artist:artist})
